...
const functions = {
    ...
    sortPeople: (order)=>{   
       ...
       const ageByDescending = ()=>{ return results.sort((age1, age2) =>{ return age2.age - age1.age });}
      
       const firstnameByAlphabeticalOrderA_Z = () =>{ return results.sort((a,b)=>{ return a.name.substring(0).localeCompare(b.name.substring(0)) });}
       ...
       switch(order){
            case 'ageByDescending': return ageByDescending()
                break;
            case 'byfirstNameOrder': return firstnameByAlphabeticalOrderA_Z()
                break; 
            case 'allAges': return extractAges()
                break;
                default: return
       }
